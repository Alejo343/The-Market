...
new class extends Component {
    ...
    /**
     * Computed property para obtener las marcas filtradas
     */
    public function with(BrandService $brandService): array
    {
        try {
            if ($this->search) {
                $brands = $brandService->search($this->search);
            } else {
    ...
    public function edit(int $id)
    {
        ...
        try {
            ...
            $this->errorMessage = 'Error al cargar la marca';
            $this->cancelEdit();
        }
    }
     ...
     * Elimina la marca
     */
    public function delete(BrandService $brandService)
    {
        $this->resetMessages();
    ...
    {
        return match ($error) {
            'BRAND_HAS_PRODUCTS' => 'No se puede eliminar: la marca tiene productos asociados',
            default => 'Error: ' . $error,
        };
    }
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600">Gestiona las marcas de productos</p>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($brands as $brand)
                    <tr class="hover:bg-gray-50 transition-colors" wire:key="brand-{{ $brand->id }}">
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            @if ($editingId === $brand->id)
                                <div class="flex justify-end gap-2" wire:key="edit-buttons-{{ $brand->id }}">
                            ...
                            @else
                                <div class="flex justify-end gap-2" wire:key="action-buttons-{{ $brand->id }}">
